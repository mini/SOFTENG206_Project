...
/**
 * RewardsController is a class that handles all the processing and storing of information in terms of the users progress
 * through tracking the number of recordings and comparisons of names. Special features have been randomly scattered
 * throughout the application, and this class tracks the discovery of these applications when found.
 *
 * The layout is determined by 3 levels for each category: Records, Compares, and Special Features.
 */
public class RewardsController extends BaseController implements java.io.Serializable  {
    ...
    // Singleton class does not work with FXML loader! JavaFX only allows public constructors.
...
//
//
//    // Using the SINGLETON design pattern, let only one instance of this class be made
//    private static RewardsController rewardsInstance;
//
////    private RewardsController(){}  //private constructor.
//
//    public static RewardsController getInstance(){
//        if (rewardsInstance == null){ //if there is no instance available... create new one
//            System.out.println(created);
//            rewardsInstance = new RewardsController();
//        }
//
...
//    }
    ...
    /**
     * updateTrophy is a class that manages the updating of icons for the ImageView and the filling of the
     * level indicators on the Rewards screen. The determination of how each category is shown from the users'
     * progress is dependent on one of the parameters - 'level'. Once the level is determined, the layout is
     * therefore decided at runtime.
    ...
    private void updateTrophy(int level, ImageView prizeNum, Circle circleName1, Circle circleName2, Circle circleName3) {
        ...
        if (level == 1) {
            ...
            circleName1.setFill(javafx.scene.paint.Color.valueOf("#ffb71b"));
        }
        ...
        // trophy to be displayed, and two progress indicator dots to be filled in
            ...
            prizeNum.setImage(prize);
            circleName1.setFill(javafx.scene.paint.Color.valueOf("#ffb71b"));
            circleName2.setFill(javafx.scene.paint.Color.valueOf("#ffb71b"));
        }
        ...
        // trophy to be displayed, and all three progress indicator dots to be filled in
            ...
            circleName1.setFill(javafx.scene.paint.Color.valueOf("#ffb71b"));
            circleName2.setFill(javafx.scene.paint.Color.valueOf("#ffb71b"));
            circleName3.setFill(javafx.scene.paint.Color.valueOf("#ffb71b"));
        }
    ...
    /**
     * incrementRecord is a private method that increments each time the user records in NameSayer
     */
    ...
    /**
     * incrementCompare is a private method that increments each time the user compares the selected name
     * with their own recorded name in NameSayer
     */
    ...
    /**
     * incrementSpecial is a private method that increments each time the user discovers a special feature in
     * NameSayer, regardless of order.
     */
