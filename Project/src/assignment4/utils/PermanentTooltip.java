...
/**
 * Permanent Tooltip is a class that was referenced by an open-source code
 * online on Github by Dan Armbrust. The code is a utility that changes the
 * tooltip delays that can only be achieved through Java10 - due to the project
 * being based of Java8, this utility was necessary.
 *
